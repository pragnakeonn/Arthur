...
def generate_launch_description():
    ...
    urdf_rviz_dir=get_package_share_directory('create3_real')
    rp_lidar_dir = get_package_share_directory('create3_real')
    ...
    slam_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(slam_dir, 'launch', 'slam_toolbox_launch.py')))
